# What has changed: 
# blocks group multihead attention and feedforward network
# they can be applied repeatedly
# issue: very deep nn suffers from optimization issues
#
# eval loss down to 2.18
# 
...
logging.basicConfig(level=logging.DEBUG, filename=f"out_05.log")
